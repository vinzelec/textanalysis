 ...
 *
 */
public abstract class AbstractColtObjectMatrix<T extends Number> extends AbstractMatrix<T> {

	private static final Logger log = LoggerFactory.getLogger(AbstractColtObjectMatrix.class);

	protected SparseObjectMatrix2D innerMatrix;

	public AbstractColtObjectMatrix(int initialDocumentSize, int initialTokenSize) {
